<template>
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left" style="margin-top:3%;">
      <div class="title-container">
        <div>
          <img class="logo" src="../../assets/crab.png">
        </div>
        <div class="title">张氏农场蟹券后台管理系统</div>
      </div>
