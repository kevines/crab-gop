...
<template>
  <div class="app-container">
    ...
    >
      <el-table-column align="center" label="排序" prop="id">
        <template slot-scope="scope">
          <img :src="sortImg" width="40" @click="bannerUp(scope.row)">
        </template>
      </el-table-column>
      <el-table-column align="center" label="引导页名称" prop="title"/>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        <el-form-item v-if="dialogStatus!='set'" label="引导页名称" prop="title" style="width:400px">
...
export default {
  ...
  data() {
    return {
      sortImg: 'https://ganjie-oss.oss-cn-hangzhou.aliyuncs.com/img/20190330/097a2ca2-30f6-44bc-86c1-92358efe5ae220190330101633.png',
      searchForm: {
        page: 1,
        limit: 10
      },
      ...
      rules: {
        title: [
          { required: true, message: '引导页名称不能为空', trigger: 'blur' }
        ],
  ...
  methods: {
    ...
    // 表格输入框失去焦点
    tableInputBlur(e, index, cell, row) {
      this.tableForm[index][cell] = e.target.value
    },
    // 实现新增banner
    createData() {
